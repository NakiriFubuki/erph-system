<?php
// admin_teaching_reports.php - Admin teaching reports page
...
try {
    ...
    // Get all courses list (for filter)
    ...
    $stats_stmt->execute(array_slice($params, 0, -2)); // Remove limit and offset parameters
...
<body>
  <header class="header">
    <h1>ERPH System - <?= t('teaching_reports.admin_title') ?></h1>
    <div>
  ...
  <div id="reportModal" class="modal">
    <div class="modal-content">
      ...
      <div class="modal-body" id="modalBody">
        <!-- Modal content will be filled dynamically via JavaScript -->
      </div>
    </div>
  </div>
  ...
  <script>
    ...
    function displayReportDetails(report) {
      ...
      // JavaScript version of status helpers
      function getStatusText(status) {
        switch (status) {
          case 'present': return '<?= t('teaching_reports.status_present') ?>';
          case 'absent': return '<?= t('teaching_reports.status_absent') ?>';
      ...
      modalBody.innerHTML = `
        <div class="report-detail-section">
          ...
          <div class="report-detail-row">
            <span class="report-detail-label">Created at:</span>
        ...
        <div class="report-detail-section">
          ...
          <div class="report-detail-row">
            <span class="report-detail-label">Teacher name:</span>
          ...
          <div class="report-detail-row">
            <span class="report-detail-label">Teacher ID:</span>
        ...
        <div class="report-detail-section">
          ...
          <div class="report-detail-row">
            <span class="report-detail-label">Check-in time:</span>
            <span class="report-detail-value">${report.check_in || '<?= t('teaching_reports.not_checked_in') ?>'}</span>
          </div>
          <div class="report-detail-row">
            <span class="report-detail-label">Check-out time:</span>
