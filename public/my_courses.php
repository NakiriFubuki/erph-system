...
// Get course list for the current teacher
$courses = [];
$course_stats = [];
try {
    ...
    ");
    $stmt->execute([$activeAccount['id'], $activeAccount['id'], $activeAccount['id']]);
    ...
    $stats_stmt = $pdo->prepare("
        ...
        WHERE ct.teacher_id = ?
    ");
    $stats_stmt->execute([$activeAccount['id'], $activeAccount['id']]);
    $course_stats = $stats_stmt->fetch();
    
} catch (Exception $e) {
    $error = "Failed to get course information: " . $e->getMessage();
}
?>
...
<body>
    <div class="container">
        ...
        <header class="header">
            <h1>ERPH System - <?= t('my_courses.title') ?></h1>
            <div>
            ...
            <div class="courses-section">
                ...
                <?php if (empty($courses)): ?>
                    <div class="no-courses">
                        <div class="no-courses-icon"><?= glyph('layers') ?></div>
