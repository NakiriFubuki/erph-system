...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !$error) {
    ...
    if (empty($title)) {
        ...
        try {
            ...
            // Get all teachers and assign this course to them
            ...
            if ($table_check && !empty($teachers)) {
                // Assign this course to all teachers
...
<body>
    ...
    <div class="form-container">
        ...
        <div class="info-box">
            <h3><?= glyph('layers') ?> Course sharing notes</h3>
            <p>After creating a course, the system will automatically assign it to all teachers. All teachers can use and manage this course without selecting teachers individually.</p>
        </div>
        ...
        <a href="course_management.php" class="back-link"><?= glyph('arrow-left') ?> <?= t('add_course.back_to_management') ?></a>
    </div>
