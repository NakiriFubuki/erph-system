...
<?php
// login_background_manager.php - Login page background image manager
                ...
                if (isset($_FILES['background_image']) && $_FILES['background_image']['error'] === UPLOAD_ERR_OK) {
                    ...
                    if (in_array($file['type'], $allowed_types)) {
                        ...
                        if (move_uploaded_file($file['tmp_name'], $filepath)) {
                            ...
                            try {
                                if (isset($pdo)) {
                                    // Check whether background settings table exists
...
$preset_backgrounds = [
    ...
    'gradient_blue' => [
        ...
        'style' => 'linear-gradient(165deg, #1d4ed8 0%, #2563eb 35%, #3b82f6 65%, #93c5fd 100%)'
    ],
    'gradient_purple' => [
  ...
  <div class="admin-layout">
    ...
    <main>
      <div class="page-header">
        ...
        <div>
          <a href="test_background_display.php" class="btn btn-secondary" style="margin-right: 10px;"><?= t('background_manager.test_background_display') ?></a>
          <a href="debug_background.php" class="btn btn-secondary" style="margin-right: 10px;"><?= t('background_manager.debug_background_issues') ?></a>
      ...
      <div class="message success" style="margin-bottom: 20px;">
        <?= glyph('check') ?> <?= t('background_manager.database_connection_normal') ?>
        <br><small><?= t('background_manager.current_background') ?><?= htmlspecialchars($current_background) ?></small>
      </div>
      <?php endif; ?>
  ...
  <script>
    ...
    function applyBackgroundToPreview() {
      ...
      if (currentBackground !== 'default') {
        // Check whether it is a preset background
